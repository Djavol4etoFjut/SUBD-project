...
class App:
    def __init__(self):
        ...
        self.top.geometry("1321x738+428+152")
        ...
        self.create_entry = tk.Button(self.top,command=self.create_table)
        ...
        self.create_label = tk.Label(self.top)
        ...
        self.lat_entry = tk.Entry(self.top)
        ...
        self.len_entry = tk.Entry(self.top)
        ...
        self.forest_type_entry = tk.Entry(self.top)
        ...
        self.country = tk.Label(self.top)
        ...
        self.forest_type = tk.Label(self.top)
        ...
        self.nat_entry = tk.Entry(self.top)
        ...
        self.con_entry = tk.Entry(self.top)
        ...
        self.type_text = tk.Label(self.top)
        ...
        self.natural_text = tk.Label(self.top)
        ...
        self.conserved_text = tk.Label(self.top)
        ...
        self.entry_lat2 = tk.Entry(self.top)
        ...
        self.enry_len2 = tk.Entry(self.top)
        ...
        self.entry_widget_lat2 = tk.Label(self.top)
        ...
        self.entry_widget_len2 = tk.Label(self.top)
        ...
        self.add_forest_button = tk.Button(self.top)
        ...
        self.add_forest_type_button = tk.Button(self.top)
        ...
        self.delete_forest_button = tk.Button(self.top)
        ...
        self.print_while_DB_button = tk.Button(self.top, command=self.print_whole_DB)
        ...
        self.print_forests_button = tk.Button(self.top, command=self.print_forests_button)
        ...
        self.print_forest_types_button = tk.Button(self.top, command=self.print_forest_type)
        ...
        self.print_countries_button = tk.Button(self.top, command=self.print_countries_table)
        ...
        self.add_forest_message = tk.Message(self.top)
        ...
        self.forest_type_message = tk.Message(self.top)
        ...
        self.delete_forest_message = tk.Message(self.top)
        ...
        self.print_DB_message_widget('lol here will be displayed whatever u want nigga')
        
    def print_DB_message_widget(self, new_text):
        self.print_DB_message = tk.Message(self.top)
        ...
        self.print_DB_message.configure(text=new_text)
    ...
    def print_forests_button(self):
        self.print_DB_message.destroy()
        self.print_DB_message_widget(misc.forest_table_to_str(self.conn))

    def print_forest_type(self):
        self.print_DB_message.destroy()
        self.print_DB_message_widget(misc.forest_type_table_to_str(self.conn))

    def print_countries_table(self):
        self.print_DB_message.destroy()
        self.print_DB_message_widget(misc.countries_table_to_str(self.conn))

    def print_whole_DB(self):
        self.print_DB_message.destroy()
        self.print_DB_message_widget(misc.whole_db_to_string(self.conn))
